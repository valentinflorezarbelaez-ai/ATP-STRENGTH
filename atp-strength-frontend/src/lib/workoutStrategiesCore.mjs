...
export const DELTA_ARCANGEL_DAYS = [
  {
    key: "DAY_DELTA_1",
  ...
  },
  {
    ...
    focus: "Sentadilla Técnica, Dominadas con Lastre & Grip de Acero",
    isRest: false,
    exercises: [
      {
        ...
        restSeconds: 300,
        cue: "Base inamovible de titanio, cadera sólida y postura de combate invencible. Control excéntrico riguroso y salida explosiva."
      },
      {
...
export const TRAINING_PROGRAMS = [
  ...
  {
    id: "delta-arcangel",
    name: "Soldado de San Miguel Arcángel: Operador Delta & Justiciero Letal",
    shortName: "Delta Arcángel",
    badge: "5 DÍAS · POTENCIA LETAL · BAS RUTTEN + SEAGAL + ZAROR + GSP",
